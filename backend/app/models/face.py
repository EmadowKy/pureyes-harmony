...
class WorkspaceFaceGroup(db.Model):
    ...
    def to_dict(self):
        return {
            ...
            'avatar_url': f"/api/video/{self.avatar_path}" if self.avatar_path else "",
...
class WorkspaceFaceRecord(db.Model):
    ...
    def to_dict(self):
        ...
        if self.segment_id:
            ...
            seg = WorkspaceVideoSegment.query.get(self.segment_id)
            if seg:
        ...
        return {
            ...
            'crop_url': f"/api/video/{self.crop_path}" if self.crop_path else "",
