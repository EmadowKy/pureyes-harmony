# Pureyes 鸿蒙多模态视觉监控与分析系统 - 帮助中心

欢迎使用 Pureyes (清眸) 官方帮助文档与技术指南。本系统是基于鸿蒙系统架构打造的智能化多模态视觉监控与分析平台，融合了多模态视觉大语言模型、实时目标检测与跨镜头行人重识别算法，旨在为安防巡检、智能监控、团队协作与视频内容检索提供一站式解决方案。
...
- [01-系统简介与核心特性](./user-guide/01-overview.md)
- [02-客户端快速入门](./user-guide/02-quick-start.md)
...
### 3. 自建服务器部署手册
适合运维工程师及有私有化部署需求的团队：
- [01-服务器硬件配置与环境依赖](./server-deployment/01-requirements-and-env.md)
- [02-后端服务部署与运行维护](./server-deployment/02-backend-deployment-guide.md)

---

> [!TIP]
> **快速上手建议**：
> - 普通使用人员请直接阅读 [02-客户端快速入门](./user-guide/02-quick-start.md)。
> - 团队管理者请重点参阅 [04-小组协作与团队通讯录](./user-guide/04-group-collaboration.md) 与 [08-管理员控制台](./user-guide/08-admin-console.md)。
> - 二次开发或算法接入人员请转至 [开发者技术文档](./developer-guide/01-architecture-design.md)。
